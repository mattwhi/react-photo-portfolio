...
import type { PickedPhoto } from "@/components/media/MediaPicker"; // (ignore if not needed)
    ...
    <div className="relative mx-auto max-w-md">
      <GlassCard className="p-7">
        ...
        <form className="mt-6 space-y-3" onSubmit={onSubmit}>
          ...
          <button
            disabled={loading}
            className="mt-5 w-full rounded-2xl bg-linear-to-r from-zinc-900 to-zinc-700 px-3 py-2.5 text-sm font-semibold text-white shadow-lg shadow-black/20 transition hover:brightness-110 disabled:opacity-60 active:scale-[0.99]"
          >
